...
public class CarDealerRunnerImpl implements CommandLineRunner {
    ...
    @Autowired
    public CarDealerRunnerImpl(CarService carService, CustomerService customerService, PartService partService, SupplierService supplierService, SaleService saleService) {
